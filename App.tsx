      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-12 space-y-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-10">
          ...
          <p className="text-slate-500 text-lg">
            Enter any sentence, phrase, or even just a few words below to get a smart summary, a fun emoji remix, and a polished formal version.
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl shadow-slate-200/50 p-1 ring-1 ring-slate-100 max-w-3xl mx-auto">
          <div className="relative">
            <textarea
              ...
              placeholder="Type a sentence, phrase, or just a few words..."
